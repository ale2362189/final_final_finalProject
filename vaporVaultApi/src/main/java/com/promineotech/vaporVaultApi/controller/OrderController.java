...
public class OrderController {
	...
	public ResponseEntity<Object> createOrder(@RequestBody Set<Long> recipeIds, @PathVariable Long id) {
		try {
			return new ResponseEntity<Object>(service.submitNewOrder(recipeIds, id), HttpStatus.CREATED);
		} catch (Exception e) {
